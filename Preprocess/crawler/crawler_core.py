                ...
                if self.check_and_close_popup():
                    ...
                    if frames: 
                        ...
                        if idx < len(retry_items):
                            ...
                            text_el = None
                            try: 
                                text_el = retry_item.find_element(By.CSS_SELECTOR, "span.xBZDS")
                            except:
                                try: 
                                    text_el = retry_item.find_element(By.CSS_SELECTOR, "span.TYaxT")
                                except: 
                                    pass
        ...
        for category in categories:
            try:
                ...
                while page <= 10:
                    ...
                    found_count = self.process_page(region, category, keyword, csv_path, existing_names, page)
